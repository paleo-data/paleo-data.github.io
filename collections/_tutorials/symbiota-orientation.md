...
description: This page is intended to help data providers 1) determine whether the Paleo Data Portal will be an appropriate tool for managing and sharing data associated with their collection and 2) understand key information for leveraging the portal’s built-in tools for data mobilization.
topics: [symbiota]
status: published
toc: true
toc_sticky: true
...
# Portal Scope
The {% include resource_link filename='pdp.yml' %}’s scope is described on its home page:
...
In other words, the portal is intended for actively managing and sharing specimen data from fossil collections that can be used for research and are held in public trust, for example, by a university collection or nonprofit museum. It is not intended for use by teaching collections or collections that are not publicly accessible.
