...
| **Basis of record** | Every record corresponding to cataloged fossil material should receive the dwc:basisofrecord value, "FossilSpecimen". <br>**Example:** dwc:basisOfRecord = `FossilSpecimen` |
