...
The **Organizing Team** is composed of 3-5 members who volunteer to commit to leading the working group for at least a year and who meet regularly (approximately monthly). This group sets the vision and strategy for PDWG. They also coordinate and host [happy hours](/community/pdwg-happy-hours), and manage access to shared communication platforms including the Google Group, Slack Workspace, and Google Drive. Contact the Organizing Team at {% include email.html %}.
